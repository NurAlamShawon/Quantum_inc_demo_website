  ...
  return (
    <div className='w-full xl:flex items-center flex-row m-10 bg-[url("https://i.postimg.cc/PfWmVyCk/Rectangle-1.png")] bg-cover bg-center'>
      <div className="xl:w-1/2 bg-transparent w-full max-w-md mx-auto mt-10 p-6  rounded shadow my-5">
        <div>
          <form className="space-y-6" onSubmit={handlelogin}>
            ...
            <p className="font-semibold text-base text-white text-center">
              ...
              <Link
                to="/authentication"
                className="text-[#05AF2B] pl-2 cursor-pointer"
              >
                Signin
              </Link>{" "}
            </p>
        ...
        <p className="text-xs w-90 mt-6 text-center text-white/60">
          By joining, you agree to the Fiverr{" "}
          <span className="text-green-500">Terms of Service</span> and to
